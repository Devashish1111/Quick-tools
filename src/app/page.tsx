...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="min-h-[100dvh] font-sans selection-glow pb-20 relative text-[var(--qt-text)] flex flex-col">
        <MouseGlow />
        ...
        >
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <a href="/tools/url-shortener" className="qt-btn qt-btn-sm px-5">Launch App <ArrowRight className="w-3.5 h-3.5" /></a>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t px-6 py-5 space-y-2"
              ...
              <a href="/tools/url-shortener" className="qt-btn w-full flex items-center justify-center gap-2 mt-3">
          ...
          <div className="relative z-10 max-w-7xl mx-auto w-full flex-1 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-end mt-6">
              ...
              <div className="flex flex-wrap gap-3 animate-fade-in" style={{ animationDelay: '1s' }}>
                <a href="/tools/url-shortener" className="qt-btn px-8 py-4">
        ...
        <section id="tools" className="py-32 px-6 md:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-16">
              ...
              <a href="/tools/url-shortener" data-reveal="right"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              {featuredTools.map((tool, i) => {
                ...
                return (
                  <Link key={i} href={`/tools/${tool.id}`} data-reveal="scale" data-delay={String(i)}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3">
              {allTools.slice(3).map((tool, i) => {
                const Icon = tool.icon;
                return (
                  <Link key={i} href={`/tools/${tool.id}`} data-reveal="scale" data-delay={String(i % 5)}
            ...
            <div className="mt-12 text-center" data-reveal>
              <a href="/tools/url-shortener" className="qt-btn px-12 py-4 inline-flex gap-2">
          ...
          <div className="max-w-7xl mx-auto pt-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div data-reveal className="grid grid-cols-2 gap-6">
              <div>
                ...
                {['URL Shortener', 'QR Generator', 'Password Gen', 'JSON Formatter'].map(t => (
                  <a key={t} href="/tools/url-shortener" className="block text-xs py-1.5 transition-colors no-underline"
            ...
            <div data-reveal="right" className="flex flex-col justify-between">
              ...
              <div>
                ...
                <a href="/tools/url-shortener" className="qt-btn inline-flex gap-2">
                  Launch App <ArrowRight className="w-4 h-4" />
                </a>
              </div>
            </div>
